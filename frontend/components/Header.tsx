    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
      ...
      <div className="container-nabbis flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/auth/login" className="text-gray-700 hover:text-purple-primary transition-colors hidden md:block" aria-label="Account">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 px-4 py-4 space-y-3">
          ...
          <Link href="/auth/login" className="block text-sm font-medium text-gray-700" onClick={() => setMenuOpen(false)}>Account</Link>
        </div>
      )}
    </header>
  );
